...
const TransmissionArchive = ({ userId }) => {
  ...
  if (loading) {
      return (
        <div className="lg:col-span-7 glass rounded-[3rem] border-white/5 bg-surface-2/20 h-[1130px] overflow-y-hidden">
            <InquirySkeleton />
        </div>
      );
  }
  ...
  return (
    <div className="lg:col-span-7">
        <div className="glass rounded-[3rem] border-white/5 min-h-[1020px] flex flex-col overflow-hidden bg-surface-2/20">
            ...
            <div className="flex-1 p-8 md:p-10 overflow-y-auto max-h-[1020px] scrollbar-custom">
                {inquiries.length === 0 ? (
